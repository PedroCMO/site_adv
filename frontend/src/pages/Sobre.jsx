        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 mb-3">Integridade</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 mb-3">Excelência</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-xl font-serif font-bold text-slate-900 mb-3">Compromisso</h3>
