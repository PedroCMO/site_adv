      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              Há mais de [anos] anos defendendo seus direitos com dedicação.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/sobre" className="text-gray-400 hover:text-gold-400 transition-colors duration-300 text-sm">
                  Sobre Nós
                </Link>
              </li>
              <li>
                <Link to="/equipe" className="text-gray-400 hover:text-gold-400 transition-colors duration-300 text-sm">
                  Nossa Equipe
                </Link>
              </li>
              <li>
                <Link to="/contato" className="text-gray-400 hover:text-gold-400 transition-colors duration-300 text-sm">
                  Contato
                </Link>
              </li>
              <li>
                <Link to="/legislacao" className="text-gray-400 hover:text-gold-400 transition-colors duration-300 text-sm">
                  Legislação
                </Link>
              </li>
            </ul>
              ...
              <div className="space-y-3 text-sm">
                ...
                {escritorio.telefone && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`tel:${escritorio.telefone}`} className="text-gray-400 hover:text-gold-400 transition-colors">
                      {escritorio.telefone}
                    </a>
                  </div>
                )}
                ...
                {escritorio.whatsapp && (
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-gold-500 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href={`https://wa.me/${escritorio.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gold-400 transition-colors">
                      {escritorio.whatsapp}
                    </a>
                  </div>
                )}
                ...
                {escritorio.email && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`mailto:${escritorio.email}`} className="text-gray-400 hover:text-gold-400 transition-colors">
                      {escritorio.email}
                    </a>
                  </div>
                )}
          ...
          <div className="mt-8 pt-8 border-t border-navy-800">
            <div className="flex flex-wrap gap-4">
              {escritorio.instagram && (
                <a href={escritorio.instagram} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gold-400 transition-colors">
              ...
              {escritorio.linkedin && (
                <a href={escritorio.linkedin} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gold-400 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {escritorio.facebook && (
                <a href={escritorio.facebook} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gold-400 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-navy-800 text-center">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Juris Consultoria. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
