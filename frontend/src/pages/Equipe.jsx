          ...
          {!advogados || advogados.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {advogados.map((advogado) => (
                ...
                >
                  {/* Photo Section */}
                  <div className="relative h-64 bg-gradient-to-br from-navy-800 to-navy-900 overflow-hidden">
                    {advogado.foto_perfil ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <div className="w-24 h-24 bg-gold-600 rounded-full flex items-center justify-center">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-navy-900 to-transparent h-20"></div>
                  </div>
